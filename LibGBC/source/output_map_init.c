...
psn_struct* psn_sun, psn_struct* psn_shade, summary_struct* summary)
{
	...
	if (ok)
	{
		...
		/*new added variables 2013-03-27*/
		output_map[647] = &summary->leafc_sum;
		output_map[648] = &summary->stemc_sum;
		output_map[649] = &summary->crootc_sum;
		output_map[650] = &summary->daily_root_mr;
		output_map[651] = &summary->leafc_max;
		output_map[655] = &summary->crootc_max;
		output_map[656] = &summary->frootc_max;
		output_map[657] = &summary->vegc_max;
		output_map[658] = &summary->litrc_max;
		output_map[659] = &summary->soilc_max;
		output_map[660] = &summary->totalc_max;
		/*添加冻土模块的变量，土壤水，土壤冰*/
		output_map[652] = &ws->FSM_soilw;
		output_map[653] = &ws->FSM_icew;
		output_map[654] = &ws->FSM_snoww;
	}
